...
public class MenuItem extends JPanel {
    ...
    public MenuItem(MenuCont menu, String menus[], int menuIndex, List<MenuEvent> events) {
        this.menu = menu;
        this.menus = menus;
    ...
    private Icon getIcon() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("Menu/icon/Cont/" + menuIndex + ".svg");
