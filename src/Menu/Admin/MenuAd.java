...
import Menu.Admin.*;
import Menu.Modo.LightDarkMode;
...
import Menu.Modo.ToolBarAccentColor;

/**
 *
 * @author Raven
 */
public class MenuAd extends JPanel {

    private final String menuItems[][] = {
        {"~Home~"},
        {"Inicio"},
        {"~Control de personas~"},
        {"Clientes", "Control de clientes", "Agregar vehiculo", "Reportes de clientes", "Reportes con parametros"},
        {"Mecanicos", "Control de mecanicos", "Reportes de mecanicos", "Reportes con parametros"},
        {"Contadores", "Control de contadores", "Reportes de contadores", "Reportes con parametros"},
        {"Recepcionistas", "Control de recepcionistas", "Reportes de recepcionistas", "Reportes con parametros"},
        {"~Citas~"},
        {"Citas"},
        {"~Otros~"},
        {"Proveedores"},
