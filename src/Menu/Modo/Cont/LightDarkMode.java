package Menu.Modo.Cont;

import Menu.Modo.Meca.*;
import Menu.Modo.*;
...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Claro", new FlatSVGIcon("Menu/Modo/light.svg"));
        buttonDark = new JButton("Oscuro", new FlatSVGIcon("Menu/Modo/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("Menu/Modo/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("Menu/Modo/light.svg"));
        }
    }
