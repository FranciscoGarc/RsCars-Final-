...
public class MenuItem extends JPanel {
    ...
    public MenuItem(MenuRecep menu, String menus[], int menuIndex, List<MenuEvent> events) {
        this.menu = menu;
        this.menus = menus;
    ...
    private Icon getIcon() {
        ...
        FlatSVGIcon icon = new FlatSVGIcon("Menu/icon/Recep/" + menuIndex + ".svg");
